 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://example.baloise.ch/", wsdlLocation = "http://localhost:8080/webservice-with-interceptor/MyService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://example.baloise.ch/", "MyServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservice-with-interceptor/MyService?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://example.baloise.ch/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.baloise.ch/", "MyServicePort"), MyService.class, features);
    }
